            ...
            <div className='book'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="book-title">
                        <input ref={bookTitle} id='bookTitle' type='text' value={title} onChange={(e) => setTitle(e.target.value)} placeholder='Title' />
                    </div>
                    <div className="book-author">
                        <input ref={bookAuthor} id='bookAuthor' type='text' value={author} onChange={(e) => setAuthor(e.target.value)} placeholder='Author' />
                    </div>
                    <div className="book-price">
                        <input ref={bookAmount} id='bookPrice' type='number' value={amount} onChange={(e) => setAmount(e.target.value)} placeholder='Price' />
                    </div>
